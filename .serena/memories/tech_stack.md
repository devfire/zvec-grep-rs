...
- AST & Parsing: `tree-sitter` (v0.25) with language grammars (Rust, Python, TypeScript, JavaScript, Go, C, C++, Java), `pulldown-cmark` (v0.13) for Markdown
- Embeddings & Tokenization: `tokenizers` (v0.21, onig/http features), `safetensors` (v0.6), `half` (v2), Model2Vec / Qwen local backends
